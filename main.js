...
{ if (error) { console.error(error); } 
    ...
    document.getElementById("result_object_name").innerHTML = results[0].label; gesture = results[0].label; toSpeak = ""; 
...
function speak(){ var synth = window.speechSynthesis; speak_data = toSpeak; 
